...
amass enum -v -brute -min-for-recursive 2 -d $1 -config ./amass-config.ini | anew /var/www/html/$1-$3/$1-subs.txt | shuffledns -r ./resolvers.txt -d $1 -w ./subdomains.txt | anew /var/www/html/$1-$3/$1-subs.txt | ./findomain-linux -t $1 | anew /var/www/html/$1-$3/$1-subs.txt | subfinder -d $1 | anew /var/www/html/$1-$3/$1-subs.txt | shuffledns -r ./resolvers.txt | anew /var/www/html/$1-$3/$1-subs.txt
...
if [[ "$2" == "full_scan" ]]
then
(python3 dirsearch/dirsearch.py -l /var/www/html/$1-$3/$1-subdomains.txt -e php,html,json,aspx -w ./dirsearch/db/dicc.txt --random-agents -b -t 100 -x 301,302,400,403,400,429,307,503,500,305 --plain-text-report=/var/www/html/$1-$3/$1-dirsearch.txt)
