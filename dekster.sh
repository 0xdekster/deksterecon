...
if [[ "$2" == "full_scan" ]]
then
python3 dirsearch/dirsearch.py --url-list=/var/www/html/$1-$3/$1-subdomains.txt -e php,html,json,aspx -w ./subdomains.txt -b -x 301,302,400,403,400,429,307,305 --plain-text-report=/var/www/html/$1-$3/$1-dirsearch.txt
