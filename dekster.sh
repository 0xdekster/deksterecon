...
if [[ "$2" == "full_scan" ]]
then
cd dirsearch && python3 ./dirsearch.py --url-list=/var/www/html/$1-$3/$1-subdomains.txt -e php,html,js,jar,aspx,asmx -b -t 40 -x 301,302,401,503,407,402,400,403,404,500,405,407,429,406,504,503,502,403,308 --plain-text-report=/var/www/html/$1-$3/$1-dirsearch.txt
cd ..
